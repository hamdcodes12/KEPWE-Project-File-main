    ...
    <div className="ledger-layout">
      ...
      <aside className={`ledger-sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="ledger-sidebar-nav">
          ...
          {[
            { id: 'compliance', label: 'Statutory Calendar', icon: Calendar },
            { id: 'gst_center', label: 'GST Center (1 & 3B)', icon: Layers },
            { id: 'einvoice_ewb', label: 'E-Invoice & E-Way Bill', icon: QrCode },
            { id: 'tds_center', label: 'TDS Center (26Q)', icon: Calculator },
          ].map((item) => {
            const Icon = item.icon;
            const isActive = activeTab === item.id;
            return (
          ...
          <div className="nav-section-label">Accounting & Operations</div>
          {[
            { id: 'journals', label: 'General Journals', icon: Scale },
            { id: 'payroll', label: 'Payroll & Statutory', icon: Users },
          ...
          <div className="topbar-left">
            ...
            <div>
              <div className="topbar-page-title">
                ...
                {activeTab === 'compliance' && 'Statutory Compliance Calendar'}
                {activeTab === 'gst_center' && 'GST Center & Returns (GSTR-1 / 3B)'}
                {activeTab === 'einvoice_ewb' && 'E-Invoice (IRN) & E-Way Bill Hub'}
                {activeTab === 'tds_center' && 'TDS Withholding Center (Form 26Q)'}
                {activeTab === 'journals' && 'Double-Entry General Journal'}
                {activeTab === 'payroll' && 'Payroll & Statutory Deductions'}
