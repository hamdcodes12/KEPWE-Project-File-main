...
import { PRODUCT_CONFIG } from './LoginPage';
    ...
    <div className="signup-root">
      <div className="signup-container">
        ...
        <div className="signup-brand-header">
          <Link to="/" className="signup-brand-logo-link" aria-label="KEPWE Home">
            <img src={kepweLogo} alt="Kepwe Logo" className="signup-brand-logo-img" />
          </Link>
          <h1 className="signup-brand-title">{productConfig ? productConfig.title : 'Kepwe'}</h1>
          <p className="signup-brand-sub">{productConfig ? productConfig.sub : 'BUSINESS PLATFORM'}</p>
          <p className="signup-brand-trial">{productConfig ? productConfig.tagline : 'Start your business journey with KEPWE — unified accounting, compliance & capital.'}</p>
        </div>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="signup-terms-row" onClick={() => setForm(p => ({ ...p, termsAccepted: !p.termsAccepted }))}>
                ...
                <label htmlFor="terms-accept" className="signup-terms-label" onClick={(e) => e.stopPropagation()}>
                  ...
                  . I agree to Kepwe platform terms and conditions.
                </label>
              </div>
              {errors.terms && (
              ...
              <div className="signup-signin-prompt">
                {productConfig ? (
                  <>
                    Already have a {productConfig.brand} account?{' '}
                    <Link to={productConfig.loginPath} className="signup-signin-link">
                      Sign in
                    </Link>
                  </>
                ) : (
