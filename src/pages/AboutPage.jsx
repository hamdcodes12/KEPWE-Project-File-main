...
const ecosystemLinks = [
  {
    title: 'Healweal Corporate',
    domain: 'healwealcorp.in',
    url: 'https://healwealcorp.in',
    tagline: 'Parent enterprise, strategic governance & corporate incubation.',
  ...
  },
  {
    ...
    domain: 'hapdax.in',
    url: 'https://hapdax.in',
    tagline: 'Digital asset exchange infrastructure & modern trading platforms.',
    category: 'Exchange & Trading'
  },
  {
    title: 'Kepwe Ecosystem',
    domain: 'kepwe.in',
    url: 'https://kepwe.in',
    tagline: 'Connected financial technology, digital banking & business tools.',
    category: 'Fintech Ecosystem'
  },
  {
    title: '7Elevos',
    domain: '7elevos.com',
    url: 'https://7elevos.com',
    tagline: 'Enterprise engineering, scalable software & tech consulting.',
    category: 'Technology & Cloud'
  },
  {
    title: 'Thinkatic',
    domain: 'thinkatic.com',
    url: 'https://thinkatic.com',
    tagline: 'Digital innovation studio, product strategy & creative development.',
    category: 'Design & Strategy'
  },
  {
    title: 'Healweal Business School',
    domain: 'healwealbusinessschool.in',
    url: 'https://healwealbusinessschool.in',
    tagline: 'Executive leadership, practical entrepreneurship & business education.',
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <section style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto 52px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap', marginTop: '28px' }}>
            <button onClick={() => navigate('/')} style={{ background: '#214ECF', color: '#FFFFFF', border: 'none', borderRadius: '10px', padding: '14px 24px', fontWeight: 800, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          ...
          {/* Connected Ecosystem & Ventures */}
          <div style={{ marginTop: '54px', textAlign: 'left' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '22px' }}>
              <span style={{ height: '1px', width: '36px', background: '#CBD5E1' }} />
              <span style={{ fontSize: '0.78rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.12em', color: '#64748B' }}>
                Connected Ecosystem & Ventures
              </span>
              <span style={{ height: '1px', width: '36px', background: '#CBD5E1' }} />
            </div>
              ...
              {ecosystemLinks.map((item) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 8px 20px rgba(33, 78, 207, 0.1)';
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                      <span style={{ fontSize: '0.72rem', fontWeight: 800, color: '#214ECF', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                        {item.category}
                      </span>
                    ...
                    <div style={{ fontSize: '0.84rem', color: '#64748B', lineHeight: '1.5', marginBottom: '12px' }}>
                      {item.tagline}
                    </div>
                  </div>
                  <div style={{ fontSize: '0.78rem', fontWeight: 700, color: '#214ECF', display: 'flex', alignItems: 'center', gap: '4px' }}>
                    {item.domain} →
                  </div>
                </a>
              ))}
        ...
        <section style={{ marginBottom: '72px' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <button onClick={() => navigate('/ledger')} style={{ background: 'transparent', color: '#214ECF', border: '1px solid #BFDBFE', borderRadius: '10px', padding: '12px 18px', fontWeight: 800, cursor: 'pointer' }}>
        ...
        <section style={{ marginBottom: '72px', background: 'linear-gradient(135deg, #0F172A 0%, #1D4ED8 100%)', color: '#FFFFFF', borderRadius: '22px', padding: '40px 24px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap', marginTop: '26px' }}>
            <button onClick={() => navigate('/')} style={{ background: '#FFFFFF', color: '#0F172A', border: 'none', borderRadius: '10px', padding: '14px 22px', fontWeight: 800, cursor: 'pointer' }}>
              Explore Kepwe
            </button>
