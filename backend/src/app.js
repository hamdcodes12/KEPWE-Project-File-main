...
// ── Sensitive Data Anti-Caching Middleware ──────────────────────────
// Ensures authenticated API responses cannot be stored by intermediate proxies
// or shared browser caches.
...
app.use('/api/leads', (req, res, next) => {
  if (req.method === 'POST') {
    return publicSubmissionLimiter(req, res, next);
  }
  next();
});
